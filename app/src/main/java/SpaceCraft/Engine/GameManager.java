...
public class GameManager {
    ...
    public boolean saveGame() {
        ...
        boolean state = SpaceCraft.SavaIO.write(this.save, new File("save/" + this.save.getPlayer().getName() + ".scs"));
        return state;
    }
    ...
    public void refreshImagesInHubMenu() {
        ...
        Game.hubMenu.labels.stream().filter((l) -> (l.ID == 4)).forEachOrdered((l) -> {
            l.setImage(
                    ModelViewer.getImageOfSpaceship(Game.gameManager.getSave().getPlayer(), (int) (Game.engine.getHeight() * 0.5f * 1f / Game.YSCALE), (int) (Game.engine.getHeight() * 0.5f * 1f / Game.YSCALE)),
                    0,
                    0
            );
        });
    ...
    public void refreshEditorMenuImages() {
        ...
        Game.engine.getModelEditor().getMenu().labels.stream().filter((l) -> (l.ID == 8)).forEachOrdered((l) -> {
            l.setImage(
                    ModelViewer.getImageOfSpaceship(Game.gameManager.getSave().getPlayer(), (int) (Game.engine.getHeight() * 0.5), (int) (Game.engine.getHeight() * 0.5)),
                    0,
                    0
            );
        });
        ...
        for (Label l : Game.engine.getModelEditor().getMenu().labels) {
            switch (l.ID) {
                case 0:
                    ...
                    break;
                case 1:
                    l.TEXT = "Total mass: " + String.format("%.2f", Game.engine.getModelEditor().getSpaceship().getTotalMass()) + " t";
                    break;
                case 2:
                    l.TEXT = "Max speed: ";
                    break;
        ...
        for (Label l : Game.engine.getModelEditor().getShop().labels) {
            switch (l.ID) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    l.TEXT = "x" + Game.gameManager.getSave().getInventory().getNumberOfBlocks(BlockType.DOUBLE_LASER_GUN);
                    break;
                case 6:
        ...
        for (File sf : saves) {
            ...
            if (f >= last - 6) {
                try {
                    ...
                    Label l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 15),
                            "File: " + sf.getName(),
                            new Color(70, 95, 70),
                    ...
                    l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 40),
                    ...
                    l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 65),
                            "Total play time: " + (h < 10 ? "0" + h : h) + ":" + (m < 10 ? "0" + m : m) + ":" + (ss < 10 ? "0" + ss : ss),
                            new Color(80, 80, 105),
                            new Font("Tahoma", Font.BOLD, 22),
                            0.8f
                    );
                    ...
                    l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 90),
                            "Level: " + (s.getLevel() + 1),
                            new Color(75, 50, 50),
                            new Font("Tahoma", Font.BOLD, 22),
                            0.8f
                    ...
                    l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 115),
                    ...
                    l = new Label(
                            (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k),
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 140),
                    ...
                    Button b = new Button(
                            0,
                            (int) (Game.engine.getSize().getHeight() * 0.1f + 200 * i + 165),
                    ...
                    b.X = (int) (Game.engine.getSize().getWidth() * 0.32f + 450 * k);
                    b.ID = i;
                    ...
                    b.ID = i;
                    b.X = (int) (Game.engine.getSize().getWidth() * 0.32f + 110 + 450 * k);
                    Game.loadGameMenu.buttons.add(b);
                    i++;
                } catch (Exception ex) {
                }
    ...
    public int lifeBar(int max) {
        if (this.total_life_new == 0) {
            ...
            return (int) (((float) Game.gameManager.getSave().getPlayer().getTotalLife() / (float) this.total_life_new) * (float) max);
        }
    }
